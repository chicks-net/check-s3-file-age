...
sub print_help () {
	...
	print "  <access-key> is optional if you have the environment variable AWS_ACCESS_KEY defined\n";
	print "  <secret-key> is optional if you have the environment variable AWS_SECRET_KEY defined\n";
	print "\n";
	support();
}
